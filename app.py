...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=2d46b6b4-cbf6-40eb-bbce-6251e6ba0300.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=32328;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=clh97482;PWD=L4InwuLRYx5Vm4Wh",'','')
...
def requested():
    ...
    while data != False:
        ...
        url="https://www.fast2sms.com/dev/bulk?authorization=RWi6Fj4XOe9VzhcTIKwYPvgsGflZnBkorby2x5UAu1NJm8DqHpZiBR15U83ykbhuN0wmYfVAtODlgxjX&sender_id=FSTSMS&message="+msg+"&language=english&route=p&numbers="+str(data["PHONE"])
